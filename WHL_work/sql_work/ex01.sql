...
INSERT INTO Book VALUES(6,'배구 단계별 기술','굿스포츠',8000);
INSERT INTO Book VALUES(7,'야구의 추억','이상미디어',20000);
INSERT INTO Book VALUES(8,'야구를 부탁해','이상미디어',13000);
INSERT INTO Book VALUES(9,'올림픽 이야기','삼성당',7500);
INSERT INTO Book VALUES(10,'Oylmpic Champions','Pearson',13000);
...
INSERT INTO Customer VALUES(6,'박세웅','대한민국 부산','010-5555-6666');
...
-- 전체칼럼보기: select * from madangdb.book;
-- 원하는칼럼보기: select name, address from Customer;
