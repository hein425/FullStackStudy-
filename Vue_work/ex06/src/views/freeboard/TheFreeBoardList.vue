  ...
  <div class="pb-10">
    ...
    <div class="px-5">
      <table class="border border-b-gray-500 w-full">
        ...
        <tbody>
          <tr v-for="item in arr" :key="item.idx" class="cursor-pointer hover:bg-slate-500" @click="viewPage(item.idx)">
...
axios.get(`http://localhost:8080/freeboard?pageNum=${pageNum.value}`) //
  .then(res => {
